    ...
    return (
        <div className={styles.SlidingOptions}>
            ...
            >
                ...
                <SwiperSlide>
                    <Options SetAiModeOption={SetAiModeOption} icon={faAlignLeft} title={"Write an essay"} subtitle={"use it now"} option={5} />
                </SwiperSlide>
                <SwiperSlide>
                    <Options SetAiModeOption={SetAiModeOption} icon={faMusic} title={"Write song"} subtitle={"use it now"} option={6} />
                </SwiperSlide>
                <SwiperSlide>
                    <Options SetAiModeOption={SetAiModeOption} icon={faAlignLeft} title={"Write an article"} subtitle={"use it now"} option={7} />
                </SwiperSlide>
                <SwiperSlide>
                    <Options SetAiModeOption={SetAiModeOption} icon={faEquals} title={"Write scientific equation"} subtitle={"use it now"} option={8} />
                </SwiperSlide>
            </Swiper>
        </div>
    );
...
const Options = ({ title, icon, option, SetAiModeOption }) => {
    ...
    return (
        <div className={styles.Options} onClick={() => HandelClick()} aria-hidden="true" onKeyDown={() => HandelClick()}  >
