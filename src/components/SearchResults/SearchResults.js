...
import { faCaretRight, faCaretLeft, faVoicemail, faVolumeUp, faVolumeDown, faVolumeMute, faVolumeOff, faVolumeXmark } from "@fortawesome/free-solid-svg-icons";
                    ...
                    <div className="SearchResultsInnerLeft ">
                        ...
                        <div className="chatbot-result">
                            {zain.map((res, index) => {
                                ...
                                return (
                                    <>
                                        <div key={index} className="chatbot-result-row">
                                            {res}
                                            <div className="Chatbot-Voice-div">
                                                {speaking?
                                                <button className="Chatbot-Voice-btn" onClick={cancel} ><FontAwesomeIcon icon={faVolumeXmark} style={{marginRight:5}} />{"Stop"}</button>
                                                :
                                                <button className="Chatbot-Voice-btn" onClick={()=>SpeakNow(res)} ><FontAwesomeIcon icon={faVolumeUp} style={{marginRight:5}} />{"Listen"}</button>
                                                }
                                                </div>
                                            </div>
                                    </>
