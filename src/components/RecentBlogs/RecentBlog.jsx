...
import bg1 from "../../assets/images/hover/1st.jpg"
import bg2 from "../../assets/images/hover/2nd.jpg"
const RecentBlog = () => {

    const [client_Y, SetClient_Y] = React.useState()
    const [MainHeight, SetHeight] = React.useState(100)

    const HandelMouseMove = (e) => {
        console.log("Main Height=>", MainHeight)
        console.log("Sub Height=>", MainHeight - 100)
        console.log(e)
        SetClient_Y(e.clientY)
    }
    return (
        <div>
            ...
            <div className="container wrap d-flex align-items-center w-100 d-flex justify-content-center gap-5">
                <div
                    className="blog_image_background"
                ...
                <div className="rounded-2 card-possition  gap-4">
                    ...
                    <div className="inner-box p-4 bg-light rounded-2 shadow">
                        <button
                            ...
                            style={{ backgroundColor: "#77C54E", width: "109px", borderRadius: "6px", height: "26px" }}
                        >
                            Fight famine
                        </button>
